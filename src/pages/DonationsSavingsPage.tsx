...
const DonationsSavingsPage: React.FC = () => {
  ...
  }, [profile, recordCurrencies, filterCurrency]);
  ...
  if (loading) {
    return <div className="min-h-[300px] flex items-center justify-center text-xl">Loading donations...</div>;
  }
  ...
  return (
    <div className="dark:bg-gray-900">
      ...
      <div className="space-y-6">
        ...
        <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2 text-[14px] h-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                ...
                <div className="relative" ref={currencyMenuRef}>
                  <button
                    ...
                    className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 pr-[10px] text-[14px] h-10 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center space-x-2"
                  >
                    <span>{filterCurrency === '' ? (recordCurrencies[0] || '') : filterCurrency}</span>
        ...
        <button
          onClick={exportData}
                className="bg-gradient-primary hover:bg-gradient-primary-hover text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2 mt-2 md:mt-0"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 py-3 px-4">
          <div className="flex items-center justify-between">
            <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Donated</p>
                  <p className="font-bold text-gray-900 dark:text-white" style={{ fontSize: '1.2rem' }}>{currencySymbol}{analytics.total_donated}</p>
                </div>
          ...
          <div className="flex items-center justify-between">
            <div>
                  ...
                  <p className="font-bold text-gray-900 dark:text-white" style={{ fontSize: '1.2rem' }}>{currencySymbol}{pendingRecords.reduce((sum, r) => sum + (r.amount || 0), 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <span className="text-3xl font-bold text-blue-600 dark:text-blue-500">📊</span>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 py-3 px-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Top Month</p>
