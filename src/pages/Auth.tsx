...
const SocialButton: React.FC<{
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-gray-700 bg-white/80 backdrop-blur-sm border border-gray-300 rounded-lg hover:bg-white/90 dark:bg-gray-800/80 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800/90 transition-all duration-200 shadow-sm"
    >
      {isGoogle ? (
