...
export const LendBorrowAnalytics: React.FC = () => {
  const { getLendBorrowAnalytics } = useFinanceStore();
  ...
  const dummyData = useMemo(() => generateDummyData(selectedCurrency), [selectedCurrency]);
    ...
    <div className="space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={dummyData.agingData}>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {dummyData.upcomingDue.map((item) => {
